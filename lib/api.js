...
/**
 * Polls /session/status every `intervalMs` until `ready` or `error`,
 * calling `onUpdate` with every snapshot (including the transient
 * nulls/502s so the UI can say "waking up…" instead of going blank).
